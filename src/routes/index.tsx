    ...
    <div className="flex min-h-screen flex-col">
      ...
      <main>
        <section className="surface-hero relative overflow-hidden">
          ...
          />
          <div className="relative mx-auto grid max-w-6xl gap-12 px-4 py-14 sm:py-20 lg:grid-cols-[1.1fr_0.9fr] lg:items-center">
        ...
        <section className="mx-auto max-w-6xl px-4 py-12" aria-labelledby="how-it-works">
        ...
        <section className="bg-secondary/60 py-12" aria-labelledby="pillars">
        ...
        <section className="mx-auto max-w-6xl px-4 py-12" aria-labelledby="word-study">
